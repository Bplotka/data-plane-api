...
type ApiConfigSource struct {
	...
	GrpcServices []*envoy_api_v2_core2.GrpcService `protobuf:"bytes,4,rep,name=grpc_services,json=grpcServices" json:"grpc_services,omitempty"`
...
func (m *ApiConfigSource) GetGrpcServices() []*envoy_api_v2_core2.GrpcService {
	if m != nil {
...
func (m *ApiConfigSource) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.GrpcServices = append(m.GrpcServices, &envoy_api_v2_core2.GrpcService{})
...
func init() { proto.RegisterFile("config_source.proto", fileDescriptorConfigSource) }
...
var fileDescriptorConfigSource = []byte{
	...
	,
}
