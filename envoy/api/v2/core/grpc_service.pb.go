...
type GrpcService struct {
	...
	InitialMetadata []*envoy_api_v2_core.HeaderValue `protobuf:"bytes,5,rep,name=initial_metadata,json=initialMetadata" json:"initial_metadata,omitempty"`
}
...
func (m *GrpcService) GetInitialMetadata() []*envoy_api_v2_core.HeaderValue {
	if m != nil {
...
type GrpcService_GoogleGrpc_SslCredentials struct {
	...
	RootCerts *envoy_api_v2_core.DataSource `protobuf:"bytes,1,opt,name=root_certs,json=rootCerts" json:"root_certs,omitempty"`
	...
	CertChain *envoy_api_v2_core.DataSource `protobuf:"bytes,3,opt,name=cert_chain,json=certChain" json:"cert_chain,omitempty"`
}
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetRootCerts() *envoy_api_v2_core.DataSource {
	if m != nil {
		return m.RootCerts
	}
	return nil
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetPrivateKey() *envoy_api_v2_core.DataSource {
	if m != nil {
		return m.PrivateKey
	}
	return nil
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetCertChain() *envoy_api_v2_core.DataSource {
	if m != nil {
		return m.CertChain
	}
	return nil
...
func (m *GrpcService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.InitialMetadata = append(m.InitialMetadata, &envoy_api_v2_core.HeaderValue{})
...
func (m *GrpcService_GoogleGrpc_SslCredentials) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RootCerts == nil {
				m.RootCerts = &envoy_api_v2_core.DataSource{}
			}
		...
		case 3:
			...
			if m.CertChain == nil {
				m.CertChain = &envoy_api_v2_core.DataSource{}
			}
...
var fileDescriptorGrpcService = []byte{
	...
	,
}
