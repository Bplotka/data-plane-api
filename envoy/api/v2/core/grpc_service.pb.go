...
/*
	Package envoy_api_v2_core is a generated protocol buffer package.
...
type GrpcService struct {
	...
	InitialMetadata []*envoy_api_v2_core1.HeaderValue `protobuf:"bytes,5,rep,name=initial_metadata,json=initialMetadata" json:"initial_metadata,omitempty"`
}
...
func (m *GrpcService) GetInitialMetadata() []*envoy_api_v2_core1.HeaderValue {
	if m != nil {
...
type GrpcService_GoogleGrpc_SslCredentials struct {
	...
	RootCerts *envoy_api_v2_core1.DataSource `protobuf:"bytes,1,opt,name=root_certs,json=rootCerts" json:"root_certs,omitempty"`
	// PEM encoded client private key.
	PrivateKey *envoy_api_v2_core1.DataSource `protobuf:"bytes,2,opt,name=private_key,json=privateKey" json:"private_key,omitempty"`
	// PEM encoded client certificate chain.
	CertChain *envoy_api_v2_core1.DataSource `protobuf:"bytes,3,opt,name=cert_chain,json=certChain" json:"cert_chain,omitempty"`
}
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetRootCerts() *envoy_api_v2_core1.DataSource {
	if m != nil {
		return m.RootCerts
	}
	return nil
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetPrivateKey() *envoy_api_v2_core1.DataSource {
	if m != nil {
		return m.PrivateKey
	}
	return nil
...
func (m *GrpcService_GoogleGrpc_SslCredentials) GetCertChain() *envoy_api_v2_core1.DataSource {
	if m != nil {
		return m.CertChain
	}
	return nil
...
func (m *GrpcService) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.InitialMetadata = append(m.InitialMetadata, &envoy_api_v2_core1.HeaderValue{})
...
func (m *GrpcService_GoogleGrpc_SslCredentials) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.RootCerts == nil {
				m.RootCerts = &envoy_api_v2_core1.DataSource{}
			}
		...
		case 2:
			...
			if m.PrivateKey == nil {
				m.PrivateKey = &envoy_api_v2_core1.DataSource{}
			}
		...
		case 3:
			...
			if m.CertChain == nil {
				m.CertChain = &envoy_api_v2_core1.DataSource{}
			}
...
func init() { proto.RegisterFile("grpc_service.proto", fileDescriptorGrpcService) }
...
var fileDescriptorGrpcService = []byte{
	...
	,
}
