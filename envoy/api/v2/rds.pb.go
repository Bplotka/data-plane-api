...
type RouteDiscoveryServiceClient interface {
	...
	FetchRoutes(ctx context.Context, in *envoy_api_v2.DiscoveryRequest, opts ...grpc.CallOption) (*envoy_api_v2.DiscoveryResponse, error)
}
...
func (x *routeDiscoveryServiceStreamRoutesClient) Send(m *envoy_api_v2.DiscoveryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *routeDiscoveryServiceStreamRoutesClient) Recv() (*envoy_api_v2.DiscoveryResponse, error) {
...
func (c *routeDiscoveryServiceClient) FetchRoutes(ctx context.Context, in *envoy_api_v2.DiscoveryRequest, opts ...grpc.CallOption) (*envoy_api_v2.DiscoveryResponse, error) {
...
type RouteDiscoveryServiceServer interface {
	...
	FetchRoutes(context.Context, *envoy_api_v2.DiscoveryRequest) (*envoy_api_v2.DiscoveryResponse, error)
}
...
func (x *routeDiscoveryServiceStreamRoutesServer) Send(m *envoy_api_v2.DiscoveryResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *routeDiscoveryServiceStreamRoutesServer) Recv() (*envoy_api_v2.DiscoveryRequest, error) {
...
func _RouteDiscoveryService_FetchRoutes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RouteDiscoveryServiceServer).FetchRoutes(ctx, req.(*envoy_api_v2.DiscoveryRequest))
	}
...
var fileDescriptorRds = []byte{
	...
	,
}
